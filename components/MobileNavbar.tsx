...
const MobileNavbar = () => {
  ...
  return (
    <div className='relative'>
      ...
      <div className={`absolute h-screen w-[250px] bg-yellow-500 top-0 ${activeMenu ? 'left-0': 'left-[-300px]'} transition-all ease-in-out duration-300 flex items-center justify-center font-black text-lg text-white`}>
